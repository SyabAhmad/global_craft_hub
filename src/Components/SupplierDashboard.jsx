...
const SupplierDashboard = () => {
    ...
    if (!isAuthenticated || !currentUser) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#064232] to-[#f5e6d3] py-8 px-4 flex items-center justify-center">
                <div className="text-center">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#d3756b] mx-auto mb-4"></div>
                    <p className="text-[#064232]">Loading dashboard...</p>
                </div>
            </div>
        );
    }
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#e7dcca] max-w-md w-full text-center">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-[#064232] to-[#c25d52] text-white font-bold py-3 px-6 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-[#064232] to-[#d3c2a8] text-[#5e3023] font-medium py-3 px-6 rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                Refresh Page
              </button>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-[#e7dcca] text-left">
              <h3 className="text-sm font-medium text-[#064232] mb-2">Need help?</h3>
            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-[#e7dcca] mt-16">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-4xl font-bold text-[#064232] mb-2">
                                Supplier Dashboard
                            </h1>
                            <p className="text-xl text-[#064232]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-[#e7dcca] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-bold text-[#064232]">Store Status</h2>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-[#064232]">Verification Status:</span>
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-[#064232]">Total Revenue:</span>
                                <span className="text-lg font-bold text-[#d3756b]">
                                    {formatCurrency(orderStats.total_revenue)}
                                </span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-[#064232]">Store Value:</span>
                            ...
                            <button 
                                ...
                                className="w-full mt-4 bg-gradient-to-r from-[#064232] to-[#c25d52] text-white py-2 px-4 rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                            >
                                Manage Store
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-[#e7dcca] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-bold text-[#064232]">Orders</h2>
                            <div className="w-12 h-12 bg-gradient-to-br from-[#fff9f5] to-[#e7dcca] rounded-xl flex items-center justify-center">
                                <svg className="w-6 h-6 text-[#d3756b]" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                <span className="text-[#064232]">New orders:</span>
                                <span className="text-2xl font-bold text-[#d3756b]">{orderStats.pending_orders}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-[#064232]">Processing:</span>
                                <span className="text-xl font-bold text-[#f59e0b]">{orderStats.processing_orders}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-[#064232]">Completed:</span>
                                <span className="text-lg font-semibold text-green-600">{orderStats.completed_orders}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-[#064232]">Today:</span>
                                <span className="text-lg font-semibold text-[#5e3023]">{orderStats.orders_today}</span>
                            </div>
                            <button 
                                onClick={handleManageOrders}
                                className="w-full mt-4 bg-gradient-to-r from-[#064232] to-[#8c7c68] text-white py-2 px-4 rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                            >
                                Manage Orders
                            </button>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-[#e7dcca] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-bold text-[#064232]">Products</h2>
                            <div className="w-12 h-12 bg-gradient-to-br from-[#fff9f5] to-[#e7dcca] rounded-xl flex items-center justify-center">
                                <svg className="w-6 h-6 text-[#d3756b]" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="space-y-3">
                            ...
                            <button 
                                ...
                                className="w-full mt-4 bg-gradient-to-r from-[#064232] to-[#d3c2a8] text-white py-2 px-4 rounded-xl font-medium hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                            >
                                Manage Arts
                            </button>
                        </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 border border-[#e7dcca]">
                    <h2 className="text-2xl font-bold text-[#064232] mb-6 flex items-center">
                        <svg className="w-8 h-8 mr-3 text-[#064232]" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
                        </svg>
                        Quick Actions
                    </h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        <button onClick={handleAddProduct} className="group bg-gradient-to-r from-[#064232] to-[#c25d52] text-white px-6 py-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                            <svg className="w-5 h-5 mr-2 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                            </svg>
                            Add New Art
                        </button>
                        <button onClick={handleManageProducts} className="group bg-gradient-to-r from-[#064232] to-[#d3c2a8] text-[#5e3023] px-6 py-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                            <svg className="w-5 h-5 mr-2 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zm0 4a1 1 0 011-1h12a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1V8z" clipRule="evenodd" />
                            </svg>
                            View Art
                        </button>
                        <button onClick={handleStoreSettings} className="group bg-gradient-to-r from-[#064232] to-[#f5e6d3] text-[#5e3023] px-6 py-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center border border-[#e7dcca]">
                            <svg className="w-5 h-5 mr-2 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clipRule="evenodd" />
                            </svg>
                            Store Settings
                        </button>
                        <button onClick={handleManageOrders} className="group bg-gradient-to-r from-[#064232] to-[#d97706] text-white px-6 py-4 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
                            <svg className="w-5 h-5 mr-2 group-hover:animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 border border-[#e7dcca]">
                        <h3 className="text-xl font-bold text-[#064232] mb-4">Revenue Overview</h3>
                        <div className="space-y-3">
                            ...
                            <div className="flex justify-between">
                                <span className="text-[#064232]">Average Product Price:</span>
                                <span className="font-bold text-[#d3756b]">{formatCurrency(productStats.avg_price)}</span>
                            </div>
                            <div className="flex justify-between">
                                <span className="text-[#064232]">Total Orders:</span>
