      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <div className="flex space-x-4 mt-4">
            <a
              href="#"
              className="p-2 border border-[#8c7c68] rounded-full text-[#8c7c68] hover:bg-[#8c5f53] hover:text-white transition-colors"
            >
              <FaFacebookF />
            </a>
            <a
        ...
        <div>
          ...
          />
          <button className="w-full bg-[#8c7c68] text-white py-3 rounded-full hover:bg-[#c25d52] transition-colors font-bold">
            SUBSCRIBE
          </button>
        </div>
        ...
        <div className="col-span-1 md:col-span-4 text-center mt-8 pt-8 border-t border-[#8c5f53]">
          <p className="text-[#8c7c68]">
            © {new Date().getFullYear()} Global Craft Hub. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
